import {
     MESSAGE_TO_CLIENT_EVENT,
     MessageToClient,
} from "./to-client/message.dto";
import {
     MESSAGE_TO_SERVER_EVENT,
     MessageToServer,
} from "./to-server/message.dto";

export type ToClient = {
     event: typeof MESSAGE_TO_CLIENT_EVENT;
     payload: MessageToClient;
};
...
export type ToServer = {
     event: typeof MESSAGE_TO_SERVER_EVENT;
